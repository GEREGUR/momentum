...
import { ExternalLink, ThemedText, ThemedView, Collapsible, WebBadge } from '@/shared/ui';
import { BottomTabInset, MaxContentWidth, Spacing, useTheme } from '@/shared/theme';
  ...
  return (
    ...
    >
      <ThemedView className="max-w-[800px] flex-grow">
        ...
        <ThemedView className="gap-8 px-4 pt-4">
